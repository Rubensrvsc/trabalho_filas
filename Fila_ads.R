...
# Qual % da área abaixo do gráfico?
...
# Verificando aqueles abaixo do gráfico
...
for(i in 1:N_for){
  ...
  ## teste se v1 < v2 (ideal para muitas operações lógicas)
...
library(readxl)
chegadas <- read_excel("base_filas.xlsx",sheet = "chegada")
tempo_atendimento <- read_excel("base_filas.xlsx",sheet = "tempo_atendimento")
...
# número de clientes entre 11h e 16h
...
plot(tempos_atendimentos_acum/60 + 11,tempos_chegadas_acum/60 + 11,
     ...
     main = "Instantes no tempo (10h às 16h)")
...
plot(1:n_clientes_entrada,
     ...
     main = "Tempo de espera por cliente (10h às 16h)")
